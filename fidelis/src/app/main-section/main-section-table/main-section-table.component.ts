...
@Component({
  selector: 'app-main-section-table',
  templateUrl: './main-section-table.component.html',
  styleUrls: ['./main-section-table.component.scss']
})
export class MainSectionTableComponent {
  displayedColumns = ['AlertId', 'AlertTime', 'Severity', 'ClientIP', 'ServerIP', 'Protocol', 'ClientCountry'];
  // dataSource = ALERT_DATA;
  @Input() alerts: AlertsInterface[];
}

/* const ALERT_DATA: AlertsInterface[] = [
  {
    'AlertId': 24859,
